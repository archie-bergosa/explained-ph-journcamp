...
const SportsWriting = () => {
  ...
  const formStyleCriteria = [
    ...
    "Provides accurate descriptions, colorful allusions, and figures of speech to describe the players and the event/game",
  ...
  const contentCriteria = [
    "Presents a clear picture of the game's events",
          ...
          <div className="max-w-4xl mx-auto space-y-6">
            <div className="bg-gradient-to-r from-brand-teal/10 to-blue-50 border-l-4 border-brand-teal p-6 rounded-r-lg">
              <p className="text-lg text-gray-700 leading-relaxed mb-4">
                Write a <span className="font-bold text-brand-teal">sports coverage article</span> that identifies the <span className="font-bold">winning/losing angle</span> of the winner/loser—an angle that explains how they won or lost.
              </p>
              <p className="text-base text-gray-700 leading-relaxed">
                Writers are free to utilize advanced techniques such as a <span className="font-bold text-brand-teal">hammer headline and a novelty lead</span>, provided that they execute this effectively.
              </p>
            </div>

            <div className="bg-white p-6 rounded-lg border-2 border-brand-orange">
              <h3 className="text-xl font-bold text-brand-dark-teal mb-4">Key Requirements</h3>
              <div className="space-y-3">
                <div className="flex items-start gap-3">
                  <CheckCircle className="w-5 h-5 text-brand-orange flex-shrink-0 mt-0.5" />
                  <p className="text-base text-gray-700">The article must convey the <span className="font-bold">complexity of the highlights</span> in a way that is understandable to the general public, using a minimum of jargon</p>
                </div>
                <div className="flex items-start gap-3">
                  <CheckCircle className="w-5 h-5 text-brand-orange flex-shrink-0 mt-0.5" />
                  <p className="text-base text-gray-700">Language used must be <span className="font-bold">active and appropriate to the sport</span></p>
                </div>
                <div className="flex items-start gap-3">
                  <CheckCircle className="w-5 h-5 text-brand-orange flex-shrink-0 mt-0.5" />
                  <p className="text-base text-gray-700">Writers must utilize <span className="font-bold">statistical analysis</span> to back up the highlights written in the article</p>
                </div>
              </div>
            </div>

            <div className="bg-blue-50 border-l-4 border-blue-600 p-6 rounded-r-lg">
              <h3 className="text-lg font-bold text-gray-800 mb-3">Organizers will provide:</h3>
              <div className="space-y-2">
                <div className="flex items-start gap-3">
                ...
                <div className="flex items-start gap-3">
                  <div className="w-2 h-2 bg-blue-600 rounded-full flex-shrink-0 mt-2"></div>
                  <p className="text-base text-gray-700">A set of quotes from relevant individuals in the game</p>
                </div>
              </div>
            </div>
          </div>
