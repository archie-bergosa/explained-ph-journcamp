  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <ContestStatusBanner 
        ...
        endDate="2025-11-30"
        categoryName="Collaborative Desktop Publishing"
      />
          ...
          <div className="max-w-4xl mx-auto space-y-6">
            <div className="bg-gradient-to-r from-brand-teal/10 to-blue-50 border-l-4 border-brand-teal p-6 rounded-r-lg">
              <p className="text-lg text-gray-700 leading-relaxed">
                In Collaborative Desktop Publishing, a <span className="font-bold text-brand-teal">team of seven</span> will produce a <span className="font-bold">four-page, full-color publication in A4 bond paper size</span> within the <span className="font-bold text-brand-teal">given production window</span>.
              </p>
            </div>
