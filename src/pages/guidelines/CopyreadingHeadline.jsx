    ...
    <div className="min-h-screen bg-white">
      ...
      >
        <div className="container mx-auto max-w-6xl">
          ...
          >
            <FileEdit className="w-16 h-16 mx-auto mb-6 opacity-90" />
        ...
        <div className="container mx-auto max-w-5xl">
          ...
          <div className="max-w-4xl mx-auto space-y-6">
            <p className="text-lg md:text-xl text-gray-700 leading-relaxed text-center">
              <span className="font-bold text-brand-teal">Copyedit errors</span>, create an appropriate slugline and printer's direction for the headline, lead, and body, as well as write headline/s that best encapsulate the essence and angle of the erroneous article.
            </p>

            <div className="grid md:grid-cols-2 gap-6 mt-8">
              <div className="bg-white p-6 rounded-lg border-l-4 border-brand-teal">
                <h3 className="text-lg font-bold text-brand-dark-teal mb-3">Additional Requirements</h3>
                <p className="text-base text-gray-700">Participants <span className="font-bold">may or may not</span> also be required to <span className="font-bold text-brand-teal">rearrange the paragraphs</span>, depending on the activity sheet provided on the contest day.</p>
              </div>

              <div className="bg-white p-6 rounded-lg border-l-4 border-brand-orange">
                <h3 className="text-lg font-bold text-brand-dark-teal mb-3">Fact-Checking</h3>
                <p className="text-base text-gray-700"><span className="font-bold text-brand-orange">Fact-checking may be required</span> if there are incorrect facts in the article.</p>
              </div>
            </div>
          </div>
        </div>
              ...
              <div className="space-y-3 text-gray-700">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-base">Allotted for answering the activity sheet</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
      ...
      >
        <div className="container mx-auto max-w-5xl">
          ...
          <p className="text-lg text-gray-700 text-center mb-10 max-w-4xl mx-auto leading-relaxed">
            During the event, participants will complete their work <span className="font-bold text-brand-orange">by hand</span>. They will submit their entries through a handwritten output, with an activity sheet provided by the organizers.
          </p>
          ...
          <div className="max-w-4xl mx-auto space-y-8">
            ...
            <div className="bg-white p-6 rounded-lg border-2 border-brand-teal">
              <div className="flex items-center gap-3 mb-4">
                <div className="text-3xl font-bold text-brand-teal">60%</div>
                <h3 className="text-2xl font-bold text-brand-dark-teal">Copyreading</h3>
              </div>
              <ul className="space-y-2">
                {copyreadingCriteria.map((criterion, index) => (
            ...
            <div className="bg-white p-6 rounded-lg border-2 border-brand-orange">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="text-2xl font-bold text-brand-dark-teal">Headline Writing</h3>
              </div>
              <ul className="space-y-2">
                {headlineWritingCriteria.map((criterion, index) => (
                  <li key={index} className="flex items-start gap-3">
...
export default CopyreadingHeadline;
