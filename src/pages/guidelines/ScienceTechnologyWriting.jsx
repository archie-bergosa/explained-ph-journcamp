...
const ScienceTechnologyWriting = () => {
  ...
  const formStyleCriteria = [
    ...
    "Has a catchy and appropriate headline that is also clear and free of bias",
  ...
  const contentCriteria = [
    ...
    "Cites scientific references, statistics and relevant figures/facts to bolster credibility of statements and/or narratives"
  ];
    ...
    <div className="min-h-screen bg-white">
      ...
      >
        <div className="container mx-auto max-w-6xl">
          ...
          >
            <Microscope className="w-16 h-16 mx-auto mb-6 opacity-90" />
      ...
      <ContestStatusBanner 
        ...
        endDate="2025-11-26"
        categoryName="Science & Technology Writing"
      />
            ...
            <div className="bg-white p-6 rounded-lg border-2 border-brand-orange">
              ...
              <div className="space-y-3">
                <div className="flex items-start gap-3">
                  ...
                  <p className="text-base text-gray-700">Ensure that the science is <span className="font-bold">bridged to the communities</span>, finding an angle that's relevant to them while humanizing the scientific jargon that is relatable</p>
                </div>
                <div className="flex items-start gap-3">
                  <CheckCircle className="w-5 h-5 text-brand-orange flex-shrink-0 mt-0.5" />
                  <p className="text-base text-gray-700">Headlines or titles must be <span className="font-bold">catchy and interesting</span>, paired with an equally-interesting introduction or lead</p>
                </div>
              </div>
            </div>
          </div>
...
export default ScienceTechnologyWriting;
