...
const ColumnWriting = () => {
  ...
  const contentCriteria = [
    ...
    "Presents the different angles and examines both reconcilable and irreconcilable differences regarding their stand",
    "Utilizes factual information from interviews, documents reviews, data analyses and other reliable sources",
    "Displays evidence of the writers' knowledge and understanding of issues/problems",
    ...
    "Clarifies certain points of fact or argument that may cause confusion or complication"
  ];
      ...
      >
        <div className="container mx-auto max-w-5xl">
          ...
          <p className="text-lg md:text-xl text-gray-700 leading-relaxed text-center max-w-4xl mx-auto">
            Participants shall write a <span className="font-bold text-brand-teal">personalized, reflective, or interpretative column</span> grounded in the given fact sheet. It may incorporate voice, wit, commentary, and creative expression while maintaining ethical balance.
          </p>
        </div>
      </motion.section>
